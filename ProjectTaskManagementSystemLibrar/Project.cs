...
public class Project
{
    ...
    public Project(int projectId, string name, string description, DateTime startDate, DateTime endDate)
    {
    ...
    {
        return string.Format("Project ID: {0}, Name: {1}, Description: {2}, Start Date: {3}, End Date: {4}",
